...
class TwoNormalOneThreeD6PickHighestMakeTwoChargeRoller : NormalChargeRoller
{

    public override string Description => "Two normal and one 3d6-discard lowest dice charge, make at at least two";
    ...
    public override bool Success(int target)
    {
        ...
        return (_3d6Roll + normalRoll1 + normalRoll2) >= 2;
